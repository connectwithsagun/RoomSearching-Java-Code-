...
public class OnBoarding extends AppCompatActivity {
    ...
    private String about_description_array[] = {
            "by location,by room type etc",
            "real picture and real aminities"
    };
    ...
    private void bottomProgressDots(int current_index) {
        ...
        if (dots.length > 0) {
            ...
            dots[current_index].setColorFilter(getResources().getColor(R.color.teal_200), PorterDuff.Mode.SRC_IN);
        }
    }
    ...
    ViewPager.OnPageChangeListener viewPagerPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(final int position) {
            ...
            if (position == about_title_array.length - 1) {
                ...
                btnNext.setBackgroundColor(getResources().getColor(R.color.btn));
